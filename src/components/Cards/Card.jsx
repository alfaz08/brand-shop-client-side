...
const Card = ({card}) => {
  ...
  <div className="card-body text-center justify-center ">
   <h2 className="text-4xl rounded-lg bg-gradient-to-r from-purple-500 via-purple-400 to-purple-300 hover:bg-purple-900 text-black hover:text-white">Brand Name:{brand}</h2>
    </div>
  </div>
    </Link>
</div>
